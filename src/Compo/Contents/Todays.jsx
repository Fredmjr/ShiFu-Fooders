...
/* import img1 from './Users/Fredmjr/Desktop/Stacks/Foods/src/assets/img/two-burgers.png'; */
...
const Todays = () => {
  return (
    ...
    <p className=' sm:text-2xl text-lg text-center my-3 text-orange-500 font-bold'>Today's Specials </p>
    <br />
